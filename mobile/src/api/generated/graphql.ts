...
export type NoticeQuery = { notice: { id: string, title: string, description: string | null, in_return: string | null, type: NoticeType, side: NoticeSide | null, created_at: string, expires_at: string | null, distance_to_user: number | null, likes: number | null, image: { url: string | null } | null, position: { latitude: number, longitude: number }, categories: { main: { id: string | null, key: string } | null }, owner: { id: string, name: string, avatar_url: string | null } | null, company: { id: string, name: string, logo_url: string | null } | null } };
